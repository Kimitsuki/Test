...
import { Platform, View, NativeModules, NativeEventEmitter, PermissionsAndroid, Text, Button } from 'react-native';
    ...
    return (
      <View>
          ...
          <View>
            {this.state.deviceid ?
              (
                ...
                <Button title='Scan for a device' onPress={() => this.scanAndConnect()}>
        ...
        {this.state.notificationReceiving == true ? (
          <Button title='Stop Notification' onPress={() => this.stopNotication()}>
        ...
        <View>
          <View>
            <Button title='ACK' onPress={() => this.writeMesage("ACK", "ACK Writted")}>
              <Text>ACK</Text>
            </Button>
            <Button title='RIS 0' onPress={() => this.writeMesage("ris 0", "ris 0 Writted")}>
              <Text>RIS 0</Text>
            </Button>
            <Button title='RIS 1' onPress={() => this.writeMesage("ris 1", "ris 1 Writted")}>
              <Text>RIS 1</Text>
            </Button>
          </View>
        </View>
